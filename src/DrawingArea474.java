...
{
		public static void drawHorizontalLineWithOpacity(int lineColor, int lineWidth, int yPos, int opacityLevel, int xPos)
		{//method340
		...
		static void drawVerticalLineWithOpacity(int color, int xPos, int opacityLevel, int yPos, int lineHeight)
		{//method342
