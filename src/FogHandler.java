...
public class FogHandler
{
	...
	public static int fogEndDistance = 3000;

	public static int fogStartDistance = fogEndDistance - 50;
	...
	public static void adjustFogEndDistance()
	{
		...
		fogStartDistance = fogEndDistance - 50;
	}
	...
	public static void forceSmoothShadowAndShading()
	{
		...
		{
			Client.instance.pushMessage("Smooth textures is required and has been turned on.", 0, "");
			Client.smoothShading = true;
			Settings.saveSettings();
		}
		if (!Client.smoothShadow)
		{
			Client.instance.pushMessage("Smooth shadows is required and has been turned on.", 0, "");
