 ...
 * @author MGT Madness, created on 22-03-2015.
 */
public class InterfaceTextEdit
{
		...
		private static String[] interfaceFrameText = {
				"The Bank Of ShatterScape",
				" When you are ready to leave",
				"ShatterScape, use the",
				"button below to logout safely.",
				"Welcome to ShatterScape - Character Design",
				"Welcome to ShatterScape",
				"Teleports",
				"Teleports",
				"Teleports",
				"Teleports",
		...
		private static int[] interfaceFrameID = {5383, 2450, 2451, 2452, 3649, 15259, 13037, 13047, 13055, 13063, 13071, 13081, 13089, 13097, 1350, 1325, 1300, 1382, 1415, 1454, 7457, 1301, 1326, 1351, 1383, 1416, 1455, 7458, 963, 8934, 5449,
