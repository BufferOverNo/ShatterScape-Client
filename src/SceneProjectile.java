final class SceneProjectile extends SceneNode
{
		...
		public Model getRotatedModel()
		{
				...
				if (spotanim.aAnimation_407 != null)
						j = spotanim.aAnimation_407.primary[anInt1593];
		...
		public void update(int i)
		{
				...
				if (spotanim.aAnimation_407 != null)
						for (anInt1594 += i; anInt1594 > spotanim.aAnimation_407.getDuration(anInt1593);)
						{
								anInt1594 -= spotanim.aAnimation_407.getDuration(anInt1593) + 1;
								anInt1593++;
								if (anInt1593 >= spotanim.aAnimation_407.length)
										anInt1593 = 0;
						}
