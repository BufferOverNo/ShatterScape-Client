...
public class HitSplat
{
		...
		private static void draw317HitSplat(Object object)
		{
				...
				for (int hitSplatIdentity = 0; hitSplatIdentity < 4; hitSplatIdentity++)
				{
						...
						if (entity.hitsLoopCycle[hitSplatIdentity] > Client.loopCycle)
						{
								...
								if (Client.spriteDrawX > -1)
								{
										...
										if (entity.hitMarkTypes[hitSplatIdentity] != 2) // 2 = poison.
										{
										...
										{
												Client.instance.hitMarks[2].drawSprite(Client.spriteDrawX - 12, Client.spriteDrawY - 20);
										}
				...
				for (int hitSplatIdentity = 0; hitSplatIdentity < 4; hitSplatIdentity++)
				{
						...
						if (entity.hitsLoopCycle[hitSplatIdentity] > Client.loopCycle)
						{
								...
								if (Client.spriteDrawX > -1)
								{
										...
										{
												Client.cacheSprite[466].draw24BitSprite(Client.spriteDrawX - 10, Client.spriteDrawY - 22);
										}
		...
		private static void draw634HitSplat(Object object)
		{
				...
				{
						Entity entity = ((Entity) (object));
						if (entity.hitsLoopCycle[j1] > Client.loopCycle)
						{
								Client.instance.npcScreenPos(entity, entity.height / 2, "");
								if (Client.spriteDrawX > -1)
								{
										...
										{
												if (entity.hitmarkMove[j1] > -6 && System.currentTimeMillis() - entity.fadeAppliedTime[j1] > 50)
												{
														entity.hitmarkMove[j1]--;
														entity.fadeAppliedTime[j1] = System.currentTimeMillis();
												}
										...
										if (System.currentTimeMillis() - entity.hitSplatAppliedTime[j1] >= 750)
										{
												entity.hitmarkTrans[j1] -= 21;
										}
										if (entity.hitmarkTrans[j1] < 0)
										{
												entity.hitmarkTrans[j1] = 0;
										}
										hitmarkDraw(entity, String.valueOf(entity.hitArray[j1]).length(), entity.hitMarkTypes[j1], entity.hitIcon[j1], entity.hitArray[j1], entity.soakDamage[j1], entity.hitmarkMove[j1], entity.hitmarkTrans[j1], j1);
								}
						}
				}
		}
