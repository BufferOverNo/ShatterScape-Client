...
public final class TextDrawingArea extends DrawingArea
{
		...
		public TextDrawingArea(String s, StreamLoader streamLoader)
		{
				try
				{
						int length = 256;
						...
						aRandom1498 = new Random();
						aBoolean1499 = false;
						Stream stream = new Stream(FileOperations.ReadFile(ClientConstants.MAIN_CACHE_LOCATION + s));
						Stream stream_1 = new Stream(streamLoader.getDataForName("index.dat"));
						stream_1.currentOffset = stream.readUnsignedWord() + 4;
						int k = stream_1.readUnsignedByte();
						if (k > 0)
		...
		public int getTextWidth(String s)
		{
				...
				s = s.replaceAll("<col=ffff00>", "");
				s = PlayerTitle.reduceTextWidth(s);
		 ...
		 * @param k Y
		 */
		public void method389(boolean flag1, int x, int j, String s, int k)
		{
				aBoolean1499 = false;
				int l = x;
				if (s == null)
